...
public class customerListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Customer> allCustomers = cdao.getCustomerList();
        ...
        int end = Math.min(start + customersPerPage, totalCustomers);
        
        List<Customer> listC = allCustomers.subList(start, end);
