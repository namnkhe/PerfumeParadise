    ...
    <body>
        ...
        <div class="container-fluid mt-3">
            <div class="d-flex justify-content-start mb-4">
                ...
                <!-- My Orders Button with Arrow -->
                <a href="order" class="btn btn-outline-primary me-2">
                    <i class="fas fa-arrow-left"></i> My Orders
                </a>
                <!-- Order Information Button with Arrow -->
                <a href="#" class="btn btn-outline-primary">
                    <i class="fas"></i> Order Information
                </a>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <!-- Display labels and values in one column as plain text -->
                            <div class="row mb-3">
                                <div class="col-4">
